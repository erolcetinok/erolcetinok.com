...
<Figure src="/projects/low-cost-robotics-kit/1-cad.jpg" alt="CAD model of the RoboForAll chassis" caption="The chassis, designed in CAD to print on any hobbyist 3D printer." />
...
{/* IMAGE — soldering / wiring the electronics */}
...
{/* IMAGE — bench-testing the electronics before assembly */}
...
# The platform
 ...
 built roboforall.org to be the other half of the project, a place where the teacher has every resource needed to assemble, troubleshoot and then teach with the robot.
