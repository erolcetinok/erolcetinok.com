/**
 * Shared SVG icons. Sizing/color are controlled by the parent's CSS
 * (e.g. `.home-hero__social-link svg`, `.menu-overlay__social-link svg`),
 * so these render at a neutral 28×28 base and inherit `currentColor`.
 */
